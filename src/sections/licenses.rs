...
pub const MIT0: &str = "This project is licensed under the MIT No Attribution license (MIT-0).

Links for more information on the license:

- [MIT-0 License Commentary][mit0-commentary]
- [Open Source Initiative: MIT-0][mit0-osi]
